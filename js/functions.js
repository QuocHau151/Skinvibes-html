...
(function ($) {
  ...
  function selling_img() {
    ...
    if (width >= 992) {
      ...
      $(".selling-img").css({
        "background-image": "url('" + selling_img + "')",
        height: selling_section_height,
      });
    } else {
      $(".selling-img").removeAttr("style");
      $(".selling-img img").remove();
  ...
  function initialize(obj) {
    ...
    var styles = [
      ...
      },
      {
        ...
        stylers: [{ saturation: " " }, { visibility: "simplified" }],
      },
      {
      ...
      },
      {
        ...
        stylers: [{ hue: "#ffff00" }, { lightness: " " }, { saturation: " " }],
      },
    ];
  ...
  function sticky_menu() {
    ...
    if (scroll_top > menu_scroll) {
      $(".header-section .menu-block").addClass(
        "navbar-fixed-top animated fadeInDown"
      );
    } else {
      $(".header-section .menu-block").removeClass(
        "navbar-fixed-top animated fadeInDown"
      );
    }
  }
...
//       cartArray[i].price +
//       ")</td>" +
//       "<td><div class='input-group-cart'><button class='minus-item input-group-cart-addon btn btn-primary-cart' data-name=" +
//       cartArray[i].name +
//       ">-</button>" +
//       "<input type='number' class='item-count-cart ' data-name='" +
//       cartArray[i].name +
//       "' value='" +
//       cartArray[i].count +
//       "'>" +
//       "<button class='plus-item btn btn-primary-cart input-group-cart-addon' data-name=" +
//       cartArray[i].name +
//       ">+</button></div></td>" +
...
//     e.preventDefault();
//     console.log("click");
//     const name = addClass(h3(text("demo title")), "name");
//     const price = addClass(span(text("5$")), "price", "is-pulled-right");
//     const description = addClass(p(text("description")), "desc");
//     const mediaContent = addClass(
//       div(name, price, description),
//       "media-content"
//     );

//     const item = addClass(article(mediaContent), "media", "menu_item");
//     item.dataset.key = "id-2";

//     //document.getElementsByClassName("dropdown-menu")[0].appendChild(item);
//     var itemCurrent = document.getElementsByClassName("mini_cart_item")[0];
//     insertAfter(itemCurrent, item);
//   });
// });
